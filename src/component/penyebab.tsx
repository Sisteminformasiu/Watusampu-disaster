  ...
  return (
    ...
    >
      <main className="flex flex-col row-start-2 items-center sm:items-start">
        <h1 className="w-[330px] sm:w-full text-2xl sm:text-3xl font-bold text-start text-black mb-2">
          Penyebab Banjir di Watusampu ?
        </h1>
        <p className="w-[330px] sm:w-[1000px] text-lg font-medium text-slate-700 text-justify mb-4">
        ...
        <div className="w-full flex justify-center">
          <div className="grid grid-cols-1 sm:grid-cols-2 justify-center gap-y-12 gap-x-12">
            <p className="w-[330px] sm:w-96 h-40 p-4 rounded-md shadow-xl text-lg font-medium text-white bg-slate-900 text-justify overflow-y-scroll custom-scrollbar">
